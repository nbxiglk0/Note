...
1. 获取ntlmv1Response:(tips:使用`python Responder.py -I eth0 -wrfv --lm` v1有两种加密方式,可由客户端控制,使用--lm参数可以强制使用比较容易破解的算法)
  ![1](201912151.png) 
2. 使用[ntlmv1-multi](https://github.com/evilmog/ntlmv1-multi)转换格式: ![1](201912152.png) 
3. 使用[crack.sh](https://crack.sh/get-cracking/)破解得到hash![1](201912153.png)  
